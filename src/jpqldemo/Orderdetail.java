...
public class Orderdetail implements Serializable {
    ...
    public JPQL_Order getJPQLOrder() {
        return jPQLOrder;
    }

    public void setJPQLOrder(JPQL_Order jPQLOrder) {
    ...
    public String toString() {
        return "jpqldemo.Orderdetail[ orderdetailPK=" + orderdetailPK + " ]";
    }
